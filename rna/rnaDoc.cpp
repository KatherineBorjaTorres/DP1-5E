...
// rnaDoc.cpp: implementación de la clase CrnaDoc
//
...
IMPLEMENT_DYNCREATE(CrnaDoc, CDocument)

BEGIN_MESSAGE_MAP(CrnaDoc, CDocument)
END_MESSAGE_MAP()


// Construcción o destrucción de CrnaDoc
...
// Serialización de CrnaDoc

void CrnaDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
void CrnaDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CrnaDoc::InitializeSearchContent()
{
...
void CrnaDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// Diagnósticos de CrnaDoc

#ifdef _DEBUG
void CrnaDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CrnaDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
